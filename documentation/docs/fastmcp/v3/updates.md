...
<Update label="FastMCP 3.0.0" description="February 18, 2026" tags={["Releases"]}>
  <Card title="FastMCP v3.0.0: Three at Last" href="https://github.com/PrefectHQ/fastmcp/releases/tag/v3.0.0" cta="Read the release notes" img="https://mintlify.s3.us-west-1.amazonaws.com/fastmcp/v3/assets/updates/release-3-0.png">
...
<Update label="FastMCP 2.7" description="June 6, 2025" tags={["Releases"]}>
  <Card title="FastMCP 2.7: Pare Programming" href="https://github.com/PrefectHQ/fastmcp/releases/tag/v2.7.0" img="https://mintlify.s3.us-west-1.amazonaws.com/fastmcp/v3/assets/updates/release-2-7.png" cta="Read the release notes">
