...
<Update label="v4.0.4" description="2026-09-15">
  ...
  * Fix #5115: OAuthProxy accepts self-contained ID-JAG tokens even when identity\_ass by [@nandanadileep](https://github.com/nandanadileep) in [#5119](https://github.com/PrefectHQ/fastmcp/pull/5119)
  ...
  * Parse skills frontmatter with yaml.safe\_load, falling back to the line parser by [@vishnujayvel](https://github.com/vishnujayvel) in [#4701](https://github.com/PrefectHQ/fastmcp/pull/4701)
  ...
  * fix(local-provider): apply transforms in get\_tasks by [@BlueX888](https://github.com/BlueX888) in [#5117](https://github.com/PrefectHQ/fastmcp/pull/5117)
  ...
  * chore(deps): Update github actions (major) by @prefect-renovate\[bot] in [https://github.com/PrefectHQ/fastmcp/pull/4890](https://github.com/PrefectHQ/fastmcp/pull/4890)
...
<Update label="v4.0.0" description="2026-08-31">
  ...
  * Honor OAuth application\_type in DCR (SEP-837) by [@jlowin](https://github.com/jlowin) in [#4621](https://github.com/PrefectHQ/fastmcp/pull/4621)
  ...
  * Add require\_roles auth check by [@jlowin](https://github.com/jlowin) in [#4656](https://github.com/PrefectHQ/fastmcp/pull/4656)
  ...
  * Bump cryptography to 50.0.0 in the testing\_demo example by [@zzstoatzz](https://github.com/zzstoatzz) in [#4844](https://github.com/PrefectHQ/fastmcp/pull/4844)
  ...
  * Don't mutate the caller's schema in compress\_schema by [@winklemad](https://github.com/winklemad) in [#4492](https://github.com/PrefectHQ/fastmcp/pull/4492)
  * Forward upstream instructions through create\_proxy by [@verdie-g](https://github.com/verdie-g) in [#4512](https://github.com/PrefectHQ/fastmcp/pull/4512)
  ...
  * Use issuer\_url for OAuth issuer identity by [@jlowin](https://github.com/jlowin) in [#4652](https://github.com/PrefectHQ/fastmcp/pull/4652)
  ...
  * Forward enable\_cimd to Auth0, AWS Cognito and OCI providers by [@StykMartin](https://github.com/StykMartin) in [#4719](https://github.com/PrefectHQ/fastmcp/pull/4719)
  ...
  * Document Windows CI parallelism and the subprocess\_heavy marker by [@jlowin](https://github.com/jlowin) in [#4575](https://github.com/PrefectHQ/fastmcp/pull/4575)
  ...
  * docs: fix ProxyProvider docstring example calling nonexistent with\_namespace() by [@andrew-stelmach-fleet](https://github.com/andrew-stelmach-fleet) in [#4633](https://github.com/PrefectHQ/fastmcp/pull/4633)
  ...
  * Document the issuer\_url identity change for upgraders by [@jlowin](https://github.com/jlowin) in [#4658](https://github.com/PrefectHQ/fastmcp/pull/4658)
  * Cover require\_roles in the v4 highlights by [@jlowin](https://github.com/jlowin) in [#4666](https://github.com/PrefectHQ/fastmcp/pull/4666)
  ...
  * Use mcp.types directly instead of aliasing to mcp\_types in docs by [@jlowin](https://github.com/jlowin) in [#4696](https://github.com/PrefectHQ/fastmcp/pull/4696)
  ...
  * docs: cover list\_tools and restore client modules in the SDK reference by [@zzstoatzz](https://github.com/zzstoatzz) in [#4936](https://github.com/PrefectHQ/fastmcp/pull/4936)
  ...
  * chore(deps): bump mcp from 1.26.0 to 1.27.2 in /examples/testing\_demo in the uv group across 1 directory by [@dependabot\[bot\]](https://github.com/dependabot\[bot]) in [#4514](https://github.com/PrefectHQ/fastmcp/pull/4514)
  ...
  * chore(deps): bump mcp from 1.27.2 to 1.28.1 in /examples/testing\_demo in the uv group across 1 directory by [@dependabot\[bot\]](https://github.com/dependabot\[bot]) in [#4614](https://github.com/PrefectHQ/fastmcp/pull/4614)
...
<Update label="v4.0.0b1" description="2026-07-28">
  ...
  * chore(deps): bump mcp from 1.26.0 to 1.27.2 in /examples/testing\_demo in the uv group across 1 directory by [@dependabot](https://github.com/apps/dependabot) in [#4514](https://github.com/PrefectHQ/fastmcp/pull/4514)
  ...
  * chore(deps): bump mcp from 1.27.2 to 1.28.1 in /examples/testing\_demo in the uv group across 1 directory by [@dependabot](https://github.com/apps/dependabot) in [#4614](https://github.com/PrefectHQ/fastmcp/pull/4614)
...
<Update label="v3.4.5" description="2026-07-27">
  ...
  * Backport #4492 to release/3.x: don't mutate the caller's schema in compress\_schema by [@jlowin](https://github.com/jlowin) in [#4663](https://github.com/PrefectHQ/fastmcp/pull/4663)
...
<Update label="v3.2.0" description="2026-03-30">
  ...
  * \[Documentation] Move stateless\_http transport kwarg to http\_app as FastMCP constructor… by [@mhallo](https://github.com/mhallo) in [#3510](https://github.com/PrefectHQ/fastmcp/pull/3510)
